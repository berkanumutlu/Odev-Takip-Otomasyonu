...
<div class="col-sm-9">
	<div class="row">
		<div class="col-sm-12">
			<?php if(isset($_POST['ogretmen_yeni_buton'])) { admin_ogretmen_yeni_kaydet(); } ?>
			<div class="well well-lg">
				<form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
					...
					<tr>
						...
						<td>
							<div class="form-inline">
								<input class="form-control" type="text" name="ogrt_kullanici_adi" pattern=".{2,30}" maxlength="30" placeholder="Kullanıcı Adı girin" required>
								<span class="profil_span">*</span>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="password_match" data-msg="Şifre eşleşmiyor.">
								<div class="form-inline">
									<input class="form-control" type="password" name="ogrt_yeni_pass1" pattern=".{8,16}" maxlength="16" style="width:95%" required>
									<span class="profil_span">*</span>
								</div>
								<br>
								<div class="form-inline">
									<input class="form-control" type="password" name="ogrt_yeni_pass2" pattern=".{8,16}" maxlength="16" style="width:95%" required>
									<span class="profil_span">*</span>
								</div>
							</div>
						</td>
					...
					<tr>
						...
						<td>
							<div class="form-inline">
								<input class="form-control" type="text" name="ogrt_adi" pattern=".{2,30}" maxlength="30" placeholder="Ad girin" required>
								<span class="profil_span">*</span>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="form-inline">
								<input class="form-control" type="text" name="ogrt_soyadi" pattern=".{2,30}" maxlength="30" placeholder="Soyad girin" required>
								<span class="profil_span">*</span>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="form-inline">
								<input class="form-control" type="email" name="ogrt_e_posta" pattern=".{6,50}" maxlength="50" placeholder="eposta@site.com" required>
								<span class="profil_span">*</span>
							</div>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<div class="form-inline">
								<input class="form-control" type="tel" name="telno" pattern="[1-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="Telefon Numarası girin">
							</div>
						</td>
					</tr>
					<tr>
					...
					<tr class="tr_son">
						...
						<td></td>
						<td><input type="submit" class="btn btn-success" name="ogretmen_yeni_buton" value="Öğretmeni Kaydet"></td>
					</tr>
					</table>
				</form>
