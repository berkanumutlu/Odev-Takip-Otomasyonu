...
<div class="col-sm-7">
		...
		<div class="col-sm-12">
			<div class="panel panel-default text-left">
				<div class="panel-body">
					<h2><img src="images/profile_student.png" alt="Öğrenci Profili">&nbsp;Profil Bilgileri</h2>
				</div>
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-12">
			<?php if($_POST) { ogrenci_profil_bilgileri_kaydet(); } ?>
			<div class="well well-lg">
				<form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
					...
					<tr>
						...
						<td>
							<div class="form-inline">
								<input class="form-control" type="tel" name="telno" value="<?php echo $_SESSION['telno']; ?>" pattern="[1-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="Telefon Numarası girin" required>
								<span class="profil_span">*</span>
							</div>
						</td>
					</tr>
